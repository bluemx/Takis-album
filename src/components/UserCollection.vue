<template>
    ...
    <!-- Category Progress -->
      <h3 class="text-sm lg:text-xl py-2  text-white">Tienes <span class="font-semibold text-blue-200 text-shadow-lg">{{ userStore.totalOwnedCards }} estampas de {{ cardsDatabase.length }} </span> en tu álbum</h3>
